...
* JavaScript Fetch API Explained By Examples. (2022). Retrieved 14 June 2022, from https://www.javascripttutorial.net/javascript-fetch-api/
* Joubran, J., & Joubran, J. (2022). How to fetch json in JavaScript | Code to go. Retrieved 14 June 2022, from https://codetogo.io/how-to-fetch-json-in-javascript/
* Joubran, J., & Joubran, J. (2022). How to fetch XML in JavaScript | Code to go. Retrieved 14 June 2022, from https://codetogo.io/how-to-fetch-xml-in-javascript/
