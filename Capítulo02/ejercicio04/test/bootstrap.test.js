...
describe('Test unitarios para la ruta `/`', function () {
    ...
    let styletag = `<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"`
    let scripttag = `<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"`
    ...
    let bootbtn = `<button type="button" class="w-100 btn`
