...
2. Ingrese al proyecto **landing**
	...
	+ Haga clic en **Genera una clave privada**. Guarde el archivo en la carpeta _keys_ con el nombre _landing-key.json_.
...
4. (STOP 1) Edite el archivo _backend/settings.py_, con:
