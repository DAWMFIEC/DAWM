...
2. Utilice `VSCode` para editar el documento index.html, con:
    ...
    - La `estructura semántica` [sugerida](bard/guia02-bard03.pdf) por Bard.
      ...
      **Obligatorio:** Utilice 1 etiqueta &lt;header&gt;, 1 etiqueta &lt;main&gt;, 5 etiquetas &lt;section&gt;, 1 etiqueta &lt;nav&gt; y 1 etiqueta &lt;footer&gt;. El documento HTML debe contener un título (&lt;h1&gt;). Cada sección debe contener un subtítulo (&lt;h2&gt;). 
